...
from employer.views import IndexView, JobCreate, JobUpdateView, JobDeleteView, JobView, ProfileEmployertView, ProfileDeleteView, JobsView, QuickUpdateView
...
urlpatterns = [
    ...
    path('jobs/quick/<int:pk>', QuickUpdateView.as_view(), name='quick'),
